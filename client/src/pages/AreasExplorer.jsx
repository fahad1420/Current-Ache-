...
import { Search, MapPin, ChevronRight, Layers } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="self-start sm:self-auto px-3.5 py-2 rounded-xl bg-stone-100 dark:bg-[#111214] text-stone-800 dark:text-zinc-200 border border-stone-200 dark:border-zinc-800 text-xs font-bold flex items-center gap-1.5 hover:bg-stone-200 dark:hover:bg-zinc-800 transition-colors"
        >
      ...
      <div className="flex flex-col md:flex-row gap-3 items-center justify-between">
        ...
        <div className="relative w-full md:w-72">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-xs sm:text-sm bg-white dark:bg-[#111214] border border-stone-200 dark:border-zinc-800 rounded-xl focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 outline-none text-stone-900 dark:text-zinc-100"
          />
        </div>
      </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-stone-400 dark:text-zinc-500 mt-0.5">
                      {isBn ? `${loc.divisionBn} বিভাগ • ${loc.districtBn}` : `${loc.district} • ${loc.division}`}
                    </p>
                  </div>
                </div>
